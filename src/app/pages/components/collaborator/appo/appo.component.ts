...
export class AppointmentComponentColl implements OnInit, AfterViewInit {
    ...
    GetCitas(e: any) {
        if (e == 1) {
            this._getAppointment
                .getAppointmentDayOrWeekFun('apu/wuapco')
                .subscribe((appo: any) => {
                    appo.msg.map((el: any) => {
                        el.startStop = true;
                    });
            ...
            this._getAppointment
                .getAppointmentDayOrWeekFun('apu/uapdco')
                .subscribe((appo: any) => {
                    appo.msg.map((el: any) => {
                        el.startStop = true;
                    });
    ...
    CreateUserDialog(
        ...
        this.dialog
            .open(CreateAppointmentDialogBox, {
                width: '600px',
                height: '800px',
                disableClose: true,
                enterAnimationDuration,
...
export class UpdateAppointmentDialogBox {
    ...
    Updaterow(): void {
        ...
        var dias = 1;
        body.dateini = new Date(
            new Date(body.dateini).setDate(
                new Date(body.dateini).getDate() + dias
            )
        ).toLocaleDateString();
        body.datefin = new Date(
            new Date(body.datefin).setDate(
                new Date(body.datefin).getDate() + dias
            )
        ).toLocaleDateString();
        body.business = Business.business.business;
        // Sign up
        this._getAppointment.updateAppointmentFun(body).subscribe(
            (response) => {
    ...
    CloseAppointment() {
        ...
        this._getAppointment.deleteAppointmentFun(body).subscribe(
            (response) => {
...
export class CreateAppointmentDialogBox {
    ...
    GetHoursCollaborator() {
        ...
        this._getAppointment
            .gethoursCollaborator('apu/horact', body)
            .subscribe((hours: any) => {
    ...
    GetCollaborators() {
        ...
        this._getAppointment
            .getCollaborator('sf/allco', body)
            .subscribe((coll: any) => {
                this.collaborators = coll.msg.filter(
                    (el: any) =>
                        el.TypeCollaborator[0].name !== 'Administrador(a)'
                );
            });
    }
    ...
    GetTypeServices(id: any) {
        ...
        this._getAppointment
            .getTypeServices('tsv/tsxserid', body)
            .subscribe((type: any) => {
    ...
    Updaterow(): void {
        ...
        console.log(body);
        this._getAppointment.CreateAppointmentFun(body).subscribe(
            (response) => {
